                        ...
                        <div class="row">
                            ...
                            for ($i=0;$i<count($resultat);$i++){ ?>
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        <h4 class="shirt_text"><?=$resultat[$i]['nomproduit'] ?></h4>
                                        <p class="price_text">Price  <span style="color: #262626;">$ <?=$resultat[$i]['estimation']?></span></p>
                                        <div class="tshirt_img"><img src="<?=base_url('image/'.$resultat[$i]['photo'])?>"></div>
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="<?=base_url('myproduct/allProduct?idproduit='.$resultat[$i]['idproduit'])?>">Echanger</a></div>
                                            <div class="seemore_bt"><a href="#">Details</a></div>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
