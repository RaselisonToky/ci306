...
{
    public function listeMyproduct(){
        $this->load->library('session');
        $this->load->model("produit_model");
        $data = array();
        $data['olona']=$this->session->user;
        $data['produit']=$this->produit_model->getMyproduit($this->session->user['nom']);
        $this->load->view('mesproduits', $data);
    }
    ...
    public function addProduit(){
        ...
        redirect(base_url('myproduct/listeMyproduct'));
    ...
    function invitation(){
        ...
        redirect(base_url('myproduct/invitation2'));
    }
